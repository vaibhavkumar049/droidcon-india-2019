...
module.exports={
    welcome: function(conv){
        if(conv.user.last.seen){
            ...
            conv.ask(new Suggestions(['Speakers'],['Notify me'],['Register Now'],['View Details'],['About Venue']));
        }
        else{
            ...
            conv.ask(new Suggestions(['Speakers'],['Notify me'],['View Details'],['Register Now'],['About Venue']));
